    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (mUriMatcher.match(uri)) {
            ...
            case GET_STRING_SET: {
                ...
                SharedPreferences systemSharedPreferences = getSystemSharedPreferences(name, mode);
                bundle.putSerializable(KEY, (HashSet<String>) ReflectionUtil.sharedPreferencesGetStringSet(systemSharedPreferences, key, set));
            }
            break;
            default:
                if (DEBUG) {
